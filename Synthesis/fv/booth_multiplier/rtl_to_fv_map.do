...
# Generated on: Wed Jun 24 12:01:31 IST 2026 (Wed Jun 24 06:31:31 UTC 2026)
...
set logfile fv/booth_multiplier/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/booth_multiplier -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  booth.v
elaborate_design -golden -root {booth_multiplier} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/booth_multiplier/fv_map.v.gz
elaborate_design -revised -root {booth_multiplier}
...
#add_name_alias fv/booth_multiplier/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.booth_multiplier.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.booth_multiplier.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.booth_multiplier.rtl.fv_map.rpt
